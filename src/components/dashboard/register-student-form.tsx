                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField control={form.control} name="fullName" render={({ field }) => (
                            <FormItem><FormLabel>ሙሉ ስም</FormLabel><FormControl><Input placeholder="እከሌ እከሌ" {...field} autoComplete="name" /></FormControl><FormMessage /></FormItem>
                        )} />
                        <FormField control={form.control} name="christianName" render={({ field }) => (
                            <FormItem><FormLabel>የክርስትና ስም</FormLabel><FormControl><Input placeholder="ዮሐንስ" {...field} autoComplete="off" /></FormControl><FormMessage /></FormItem>
                        )} />
                        <FormField
                        ...
                        />
                         <FormField control={form.control} name="educationLevel" render={({ field }) => (
                            <FormItem><FormLabel>የትምህርት ደረጃ</FormLabel><FormControl><Input placeholder="ለምሳሌ 5ኛ ክፍል" {...field} autoComplete="off" /></FormControl><FormMessage /></FormItem>
                        )} />
                        ...
                        <FormField control={form.control} name="studentId" render={({ field }) => (
                            <FormItem><FormLabel>የተማሪ መለያ</FormLabel><FormControl><Input placeholder="ተማሪ005" {...field} onInput={(e) => (e.currentTarget.value = e.currentTarget.value.toUpperCase())} autoComplete="off" /></FormControl><FormDescription>ልዩ መለያ መሆን አለበት።</FormDescription><FormMessage /></FormItem>
                        )} />
